...
if (
    ...
    if ($password != $cpassword) {
        ...
        if (isLengthOK($password)) {
            ...
            { //desired task and continue coding for saving file and inserting user info 
              if(  move_uploaded_file($profile['tmp_name'], $profilePath)){
                ...
                try{
                    ...
                    $status = $stmt->execute([null,$email,$hashcode,$profilePath,$city,$gender,$fullname,$bdate]);
